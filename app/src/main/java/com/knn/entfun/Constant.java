...
//    public static String QUIZ_URL = "https://quizdemo.wrteam.in/api-v2.php";  //api url
    public static String QUIZ_URL = "https://kzentapps.com/api-v2.php";  //api url


    public static String FIREBASE_URL = "https://us-central1-ent-fun.cloudfunctions.net/";/*FireBase function URL*/
    /////// PARAMETERS  ///////
